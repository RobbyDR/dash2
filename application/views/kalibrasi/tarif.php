...
<div class="table-responsive">
    <table class="table table-sm text-white" id="tabeltarifkalibrasi">
        <thead>
            <tr>
                <th scope="col">#</th>
        ...
        <tbody>
            <?php foreach ($gettarifkalibrasi as $row) : ?>
                <tr>
                    <td><?= $row['id'] ?></td>
...
<script>
    // new DataTable('#tabeltarifkalibrasi');
    $(document).ready(function() {
        $('#tabeltarifkalibrasi').DataTable();
    });
